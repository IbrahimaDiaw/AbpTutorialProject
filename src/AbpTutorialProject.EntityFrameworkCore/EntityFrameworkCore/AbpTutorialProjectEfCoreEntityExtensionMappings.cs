...
public static class AbpTutorialProjectEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE AbpTutorialProjectModuleExtensionConfigurator CLASS (in the Domain.Shared project)
